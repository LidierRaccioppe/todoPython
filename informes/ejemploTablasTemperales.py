...
temperaturas = [["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Septiembre", "Octubre", "Noviembre", "Diciemebre"],
...
documento = SimpleDocTemplate("ejemploTablasTemperatura.pdf", pagesize = A4)
